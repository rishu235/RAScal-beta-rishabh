...
if(language_chosen!="english"):
    food_item = rascal_calorie_entry_demo_us(language = language_chosen, language_code = language_code)[1]
else:
    food_item = rascal_calorie_entry_demo_us(language = language_chosen, language_code = language_code)
